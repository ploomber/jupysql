...
Note: DuckDB doesn't support reading excel files. Instead, their `excel` [extension](https://duckdb.org/docs/extensions/overview) provides excel like formatting.
